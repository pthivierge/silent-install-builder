...
{
    public partial class PackagesListDemo : Form
    {
        private InstallModel _model = null;

        public PackagesListDemo()
        {
            InitializeComponent();
        }

        private void PackagesListDemo_Load(object sender, EventArgs e)
        {
            
             _model = ModelUtils.GetTestModel();

            packagesListControl1.SetModel(_model);
        }
